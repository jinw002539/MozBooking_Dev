...
| :--- | :--- | :--- | :--- |
| RF01 | Registo de Pacientes | O sistema deve permitir o cadastro de pacientes com validação de BI e Email únicos. | Must |
...
| RF05 | Regra de Exclusividade | O sistema deve impedir tecnicamente a marcação de dois pacientes no mesmo horário para o mesmo médico. | Must |
